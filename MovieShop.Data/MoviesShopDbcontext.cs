...
{
  public class MoviesShopDbcontext : DbContext
    {
        public MoviesShopDbcontext(DbContextOptions<MoviesShopDbcontext> options) : base(options)
        {
        ...
        private void ConfigureGenre(EntityTypeBuilder<Genre> builder)
        {
            ...
            //lamda expression is reqired in this method 
